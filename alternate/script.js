...
const myProjects = [
	{
		...
		tools: '<li><i class="fa-brands fa-html5" aria-hidden="true"></i></li><li><i class="fa-brands fa-css3-alt" aria-hidden="true"></i></li><li><i class="fa-brands fa-js" aria-hidden="true"></i></li>',
	...
	},
	{
		...
		tools: '<li><i class="devicon-react-original" aria-hidden="true"></i></li><li><i class="devicon-nodejs-plain" aria-hidden="true"></i></li><li><i class="devicon-sass-original" aria-hidden="true"></i></li><li><i class="fa-brands fa-js" aria-hidden="true"></i></li><li><i class="fa-solid fa-people-group" aria-hidden="true"></i></li>',
    ...
    myProjects.forEach(project => {
        ...
        projectContainer.innerHTML = `
            <div className="projectImg">
                <a href="${project.liveURL}"><img src="${project.asset}" alt="${project.title}" /></a>
            </div>
            <div className="project_desc">
                ...
                <div className="skills_used">
                    ...
                    <ul>
                        <li><a href="${project.live
                        }"><button>Live Site</button></a></li>
                        <li><a href="${project.repoURL}"><button>GitHub</button></a></li>
                    </ul>
                </div>
            </div>`
